...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		color = glm::vec3(0.94f, 0.9f, 0.42f);
		...
		color = glm::vec3(0.83f, 0.8f, 0.44f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//Articulacion1
		modelaux = model;
		model = glm::translate(model, glm::vec3(4.5f, 4.0f, -3.5f));
		...
		//Articulacion 2
		modelaux = model;
		model = glm::translate(model, glm::vec3(4.5f, 4.0f, -4.5f));
		modelaux = model;
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion2()), glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.5f, 0.5f, 0.5f));
		...
		//Pierna 2 de articulacion 2
		model = glm::translate(model, glm::vec3(-0.5f, -0.1f, 1.5f));
		model = glm::rotate(model, glm::radians(-30.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::scale(model, glm::vec3(1.0f, 1.0f, 2.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//Boca inferior de cabeza
		model = glm::translate(model, glm::vec3(-1.5f, -0.5f, 0.0f));/*
		model = glm::rotate(model, glm::radians(-15.0f), glm::vec3(0.0f, 0.0f, 1.0f));*/
		modelaux = model;
		model = glm::scale(model, glm::vec3(2.0, 0.5, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));		
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		color = glm::vec3(1.0f, 0.0f, 1.0f);
