...
float toffsetLEDSu = 0.0f;
float toffsetLEDSv = 0.0f;
...
int main()
{
	...
	LEDS = Texture("Textures/LEDS.tga");
	LEDS.LoadTextureA();
	...
	while (!mainWindow.getShouldClose())
	{
		...
		toffset = glm::vec2(toffsetLEDSu, toffsetLEDSv);
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(10.55f, 4.6f, 0.0f));
		...
		//Marco
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(10.0f, -1.15f, 0.0f));
		modelaux = model;
		...
		//Dragon
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f+cos(glm::radians(angulovaria2)), 5.0f+sin(glm::radians(angulovaria)), 6.0));
		...
		model = glm::scale(model, glm::vec3(0.3f, 0.3f, 0.3f));
		model = glm::rotate(model, -90 * toRadians, glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, movAlas * toRadians, glm::vec3(1.0f, 0.0f, 0.0f));
		Material_brillante.UseMaterial(uniformSpecularIntensity, uniformShininess);
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		AlaDer.RenderModel();
